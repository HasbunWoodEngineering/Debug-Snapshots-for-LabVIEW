...
<Project Type="Project" LVVersion="20008000">
	...
	<Property Name="NI.Project.Description" Type="Str">&lt;b&gt;Debug Snapshots for LabVIEW&lt;/b&gt; is a lightweight Quick Drop tool that lets you save, restore, and clear the debug state of a VI — including breakpoints and probes — to quickly restore debugging contexts.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="src" Type="Folder">
			<Item Name="Type Definitions" Type="Folder">
				<Item Name="Breakpoint--cluster.ctl" Type="VI" URL="../src/Type Definitions/Breakpoint--cluster.ctl"/>
				<Item Name="Class Name--enum.ctl" Type="VI" URL="../src/Type Definitions/Class Name--enum.ctl"/>
				<Item Name="Debug Snapshot--cluster.ctl" Type="VI" URL="../src/Type Definitions/Debug Snapshot--cluster.ctl"/>
				<Item Name="Snapshot Handling Options--cluster.ctl" Type="VI" URL="../src/Type Definitions/Snapshot Handling Options--cluster.ctl"/>
				<Item Name="Debug Snapshot Array--cluster.ctl" Type="VI" URL="../src/Type Definitions/Debug Snapshot Array--cluster.ctl"/>
			</Item>
			<Item Name="Constants" Type="Folder">
				<Item Name="Cache File Entry--constant.vi" Type="VI" URL="../src/Constants/Cache File Entry--constant.vi"/>
				<Item Name="Encoding--constant.vi" Type="VI" URL="../src/Constants/Encoding--constant.vi"/>
				<Item Name="No Elements Saved Message--constant.vi" Type="VI" URL="../src/Constants/No Elements Saved Message--constant.vi"/>
				<Item Name="Default Cache File Path--constant.vi" Type="VI" URL="../src/Constants/Default Cache File Path--constant.vi"/>
			</Item>
			<Item Name="core" Type="Folder">
				<Item Name="Get VI Breakpoints.vi" Type="VI" URL="../src/core/Get VI Breakpoints.vi"/>
				<Item Name="Set VI Breakpoints.vi" Type="VI" URL="../src/core/Set VI Breakpoints.vi"/>
				<Item Name="Get VI Probes.vi" Type="VI" URL="../src/core/Get VI Probes.vi"/>
				<Item Name="Set VI Probes.vi" Type="VI" URL="../src/core/Set VI Probes.vi"/>
				<Item Name="Probe on Wire Exists.vi" Type="VI" URL="../src/core/Probe on Wire Exists.vi"/>
			</Item>
			<Item Name="persistence" Type="Folder">
				<Item Name="Save Debug Snapshot.vi" Type="VI" URL="../src/persistence/Save Debug Snapshot.vi"/>
				<Item Name="Load Debug Snapshot.vi" Type="VI" URL="../src/persistence/Load Debug Snapshot.vi"/>
			</Item>
			<Item Name="Quick Drop Plugin" Type="Folder">
				<Item Name="QD Save Debug Snapshot.vi" Type="VI" URL="../src/Quick Drop Plugin/QD Save Debug Snapshot.vi"/>
				<Item Name="QD Load Debug Snapshot.vi" Type="VI" URL="../src/Quick Drop Plugin/QD Load Debug Snapshot.vi"/>
				<Item Name="QD Clear Debug Snapshot.vi" Type="VI" URL="../src/Quick Drop Plugin/QD Clear Debug Snapshot.vi"/>
			</Item>
			<Item Name="IPath Getter" Type="Folder">
				<Item Name="IPath Getter.lvclass" Type="LVClass" URL="../src/IPath Getter/IPath Getter.lvclass"/>
			</Item>
			<Item Name="Path Getter Mock" Type="Folder">
				<Item Name="Path Getter Mock.lvclass" Type="LVClass" URL="../src/Path Getter Mock/Path Getter Mock.lvclass"/>
			</Item>
			<Item Name="Path Getter" Type="Folder">
				<Item Name="Path Getter.lvclass" Type="LVClass" URL="../src/Path Getter/Path Getter.lvclass"/>
			</Item>
			<Item Name="Public API.lvlib" Type="Library" URL="../src/Public API.lvlib"/>
		</Item>
		<Item Name="tests" Type="Folder">
			<Item Name="helpers" Type="Folder">
				<Item Name="Get UIDs.vi" Type="VI" URL="../tests/helpers/Get UIDs.vi"/>
				<Item Name="Get Path to Base Test VI.vi" Type="VI" URL="../tests/helpers/Get Path to Base Test VI.vi"/>
				<Item Name="Clear VI.vi" Type="VI" URL="../tests/helpers/Clear VI.vi"/>
				<Item Name="Add Probes to all wires.vi" Type="VI" URL="../tests/helpers/Add Probes to all wires.vi"/>
				<Item Name="Add Breakpoints to All Wires.vi" Type="VI" URL="../tests/helpers/Add Breakpoints to All Wires.vi"/>
				<Item Name="Add Breakpoints to all Nodes.vi" Type="VI" URL="../tests/helpers/Add Breakpoints to all Nodes.vi"/>
			</Item>
			<Item Name="Base Test VI.vi" Type="VI" URL="../tests/Base Test VI.vi"/>
			<Item Name="Test Probe on Wire Exists - no probes.vi" Type="VI" URL="../tests/Test Probe on Wire Exists - no probes.vi"/>
			<Item Name="Test Probe on Wire Exists - with probes.vi" Type="VI" URL="../tests/Test Probe on Wire Exists - with probes.vi"/>
			<Item Name="Test Delete Cache.vi" Type="VI" URL="../tests/Test Delete Cache.vi"/>
			<Item Name="Test Probes Roundtrip.vi" Type="VI" URL="../tests/Test Probes Roundtrip.vi"/>
			<Item Name="Test Breakpoints Roundtrip.vi" Type="VI" URL="../tests/Test Breakpoints Roundtrip.vi"/>
			<Item Name="Test Save Snapshot.vi" Type="VI" URL="../tests/Test Save Snapshot.vi"/>
			<Item Name="Test Load Snapshot - all.vi" Type="VI" URL="../tests/Test Load Snapshot - all.vi"/>
			<Item Name="Test Load Snapshot - breakpoints.vi" Type="VI" URL="../tests/Test Load Snapshot - breakpoints.vi"/>
			<Item Name="Test Load Snapshot - probes.vi" Type="VI" URL="../tests/Test Load Snapshot - probes.vi"/>
			<Item Name="Test Clear Snapshot.vi" Type="VI" URL="../tests/Test Clear Snapshot.vi"/>
		</Item>
